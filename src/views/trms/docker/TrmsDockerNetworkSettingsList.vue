<template>
 <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection" :searchInfo="searchInfo">
      ...
      <TrmsDockerNetworkSettingsModal @register="registerModal" @success="handleSuccess"/>
   </div>
</template>
...
<script lang="ts" setup>
  ...
  import {downloadFile} from '/@/utils/common/renderUtils';
    ...
    const {prefixCls, tableContext, onImportXls, onExportXls} = useListPage({
        tableProps: {
            api: trmsDockerNetworkSettingsList,
            columns: trmsDockerNetworkSettingsColumns,
            canResize: false,
            useSearchForm: false,
            actionColumn: {
                width: 180,
    ...
    watch(mainId, () => {
         searchInfo['containerId'] = unref(mainId);
         reload();
      }
    );
