<template>
  <div>
    ...
    <!-- 表单区域 -->
    <TrmsExamPaperModal ref="registerModal" @success="handleSuccess"></TrmsExamPaperModal>
  </div>
</template>

<script lang="ts" name="trms-trmsExamPaper" setup>
import {ref, reactive} from 'vue';
import {BasicTable, useTable, TableAction} from '/@/components/Table';
import {useListPage} from '/@/hooks/system/useListPage';
import {columns} from './TrmsExamPaper.data';
import {list, deleteOne, batchDelete, getImportUrl, getExportUrl} from './TrmsExamPaper.api';
import {downloadFile} from '/@/utils/common/renderUtils';
import TrmsExamPaperModal from './components/TrmsExamPaperModal.vue'
